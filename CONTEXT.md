...
A personal macOS menu-bar app that records calls locally, has the cloud transcribe and diarize them, and writes summarised markdown notes into an Obsidian vault.
